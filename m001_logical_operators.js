// Find all movies that have tomato meter greater than 95 OR metacritic greater than 88.
db.movieDetails.find({ $or: [{ "tomato.meter": { $gt: 95 } }, { metacritic: { $gt: 88 } }] }, { _id: 0, title: 1, "tomato.meter": 1, metacritic: 1 });

// Find all movies that have tomato meter greater than 95 AND metacritic greater than 88.
db.movieDetails.find({ $and: [{ "tomato.meter": { $gt: 95 } }, { metacritic: { $gt: 88 } }] }, { _id: 0, title: 1, "tomato.meter": 1, metacritic: 1 });

// Find all movies that have tomato meter greater than 95 AND metacritic greater than 88.
// NOTE:
// the previous query doesn't need "$and"
